...
public class WXPayUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setAppId("wx7d498f7ffd96b40e");
        config.setKey("qwer4321qdxiaochengxu20182018xcx");
        config.setMchId("1514872221");
        WXPay wxpay = new WXPay(config);

        Map<String, String> data = new HashMap<String, String>();
        data.put("body", "nihao");
        data.put("out_trade_no", "20160909105959000000123");
        ...
        data.put("openid", "oqpIQ5UO_IlrbvQATRQjKWpq6BKM");
        try {
